...
check_sketch()
 ...
 console.log(results);
 drawn_sketch=rsults[0].label;
 document.getElementById("label").innerHTML='YourSketch:'+drawn_sketch;
 document.getElementById('Confidence').innerHTML='YourSketch:'+Math.round(results[0].confidence*100);
 ...
 function check_sketch()
 {
     ...
     if(timercheck == "completed")  answer_holder == "set"
     {
         timer_check="";
         answer_holder="";
         updateCanvas();
